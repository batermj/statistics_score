...
df_all_valueableVariable.to_excel("标签规则_all_valueableVariable.xlsx")



'''
#好变量，中等变量，差变量,或疑惑变量列表存储器
dict_goodInformative_variables={}
dict_mediumInformative_variables={}
dict_lowInformative_variables={}
dict_goodOrSuspicious_variables={}
#被选中的变量列表
list_choose=[]
#生成表格，包含价值量高的变量
